...
namespace Zeroit.Framework.Transitions.ZeroitFormAnimator
{
    ...
    public partial class ZeroitFormAnimEdit : Component
    {
        ...
        /// </summary>
        FormAnimatorInput formAnimatorInput = new FormAnimatorInput();
        ...
        public FormAnimatorInput Editor
        {
            get { return formAnimatorInput; }
            set
            {
                formAnimatorInput = value;
            }
        }
        ...
        public Timer Time
        {
            get { return formAnimatorInput.Time; }
            set
            {
                formAnimatorInput.Time = value;
            }
        }
        ...
        {
            get { return formAnimatorInput.Positions; }
            set
            {
                formAnimatorInput.Positions = value;
            }
        }
        ...
        {
            get { return formAnimatorInput.Opacity; }
            set
            {
                formAnimatorInput.Opacity = value;
            }
        }
        ...
        public Grow Grow
        {
            get { return formAnimatorInput.Grow; }
            set
            {
                formAnimatorInput.Grow = value;
            }
        }
        ...
        public Move Move
        {
            get { return formAnimatorInput.Move; }
            set
            {
                formAnimatorInput.Move = value;
            }
        }
        ...
        {
            get { return formAnimatorInput.Locations; }
            set
            {
                formAnimatorInput.Locations = value;
            }
        }
        ...
        public Shake Shake
        {
            get { return formAnimatorInput.Shake; }
            set
            {
                formAnimatorInput.Shake = value;
            }
        }
        ...
        {
            get { return formAnimatorInput.Animation; }
            set
            {
                formAnimatorInput.Animation = value;
            }
        }
        ...
        {
            get { return formAnimatorInput.MoveToPoint; }
            set
            {
                formAnimatorInput.MoveToPoint = value;
            }
        }
        ...
        public ZeroitFormAnimEdit(System.Windows.Forms.Form form)
        {
            //this.form = form;
            InitializeComponent();
        }
        ...
        public ZeroitFormAnimEdit(IContainer container)
        {
            container.Add(this);
