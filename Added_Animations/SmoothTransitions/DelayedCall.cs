...
// ***********************************************************************
// <copyright file="DelayedCall.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Transitions.SmoothTransitions
{
    ...
    public class DelayedCall : IDisposable
    {
        ...
        /// instead.
        /// </summary>
        /// <value><c>true</c> if [supports synchronization]; otherwise, <c>false</c>.</value>
        ...
        /// <exception cref="ArgumentOutOfRangeException">milliseconds - The new timeout must be 0 or greater.</exception>
        /// <exception cref="InvalidOperationException">Cannot delay calls synchronously on a non-UI thread. Use the *Async methods instead.</exception>
        ...
        /// </summary>
        /// <value>The registered count.</value>
        ...
        /// </summary>
        /// <value><c>true</c> if this instance is any waiting; otherwise, <c>false</c>.</value>
        ...
        /// waiting to fire.
        /// </summary>
        /// <value><c>true</c> if this instance is waiting; otherwise, <c>false</c>.</value>
        ...
        /// </summary>
        /// <remarks>The event will not be fired when the timeout has finished before, so when calling
        ...
        /// elapsed, use <see cref="Reset(int)" /> with 0 milliseconds.</remarks>
        public void Fire()
        {
            lock (timerLock)
            {
        ...
        /// started at all.
        /// </summary>
        /// <remarks>The event will be fired even when the timeout has finished before. This is the method
        /// used by <see cref="Fire" /> and it takes care of always unregistering the
        /// <see cref="DelayedCall" /> object from the internal list.</remarks>
        public void FireNow()
        {
            isCancelled = false;
            OnFire();
        ...
        /// <exception cref="ArgumentOutOfRangeException">value - The new timeout must be 0 or greater.</exception>
        /// <remarks>Changing the timeout before it elapsed will restart the timer with the new value.</remarks>
    ...
    /// <seealso cref="Zeroit.Framework.Transitions.SmoothTransitions.DelayedCall" />
