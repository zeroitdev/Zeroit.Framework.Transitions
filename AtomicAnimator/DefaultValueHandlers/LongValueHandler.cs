...
// ***********************************************************************
// <copyright file="LongValueHandler.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Transitions.AtomicAnimator.ValueHandlers
{
    ...
    public class LongValueHandler : IValueHandler<long>
    {
        #region IValueHandler<long> Members
        ...
        public long Interpolate(long from, long to, float amount)
        {
            double diff = (double)(to - from) * (double)amount;

            return from + (long)diff;
        }
