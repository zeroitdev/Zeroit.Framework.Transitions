...
// ***********************************************************************
// <copyright file="Animation2D.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Transitions.ZeroitPizaroAnimator
{
...

    {
        ...
        /// and 1.
        /// </summary>
        //private EasingAnimations easingAnimations;
        ...
        private void Cycle(DateTime now) {
            ...
            if (acceleration == null) {
                ...
                UpdateCoords(acceleration * (m_Progress));
            }
    ...
    public delegate void Animation2DEvent(Animation2D animation);
}
