...
// ***********************************************************************
// <copyright file="AnimatorWithEditor.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Transitions.AnimatorWithEditor
{
    ...
    public class ZeroitAnimatorEdit : Component, IExtenderProvider
    {
        ...
        /// The animate input
        /// </summary>
        private AnimateInput animateInput = new AnimateInput(Transitions.AnimatorWithEditor.AnimationType.Rotate,10, 100, 100, /*0.02f,*/ 1500,
            new Transitions.AnimatorWithEditor.ZeroitAnimate_Animation(), new Control(), 1f);
        #endregion
        ...
        {
            get { return animateInput.Duration; }
            set
            {
                animateInput.Duration = value;
            }
        }
        ...
        public ZeroitAnimate_Animation DefaultAnimation
        {
            get { return animateInput.DefaultAnimation; }
            set
            {
                animateInput.DefaultAnimation = value;
        ...
        public int Interval
        {
            get { return animateInput.Interval; }
            set
            {
                animateInput.Interval = value;
            }
        }
        ...
        {
            get { return animateInput.AnimationType; }
            set
            {
                animateInput.AnimationType = value;
                InitDefaultAnimation(animateInput.AnimationType);
            }
        }
        #endregion

        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitAnimatorEdit" /> class.
        /// </summary>
        public ZeroitAnimatorEdit()
        {
            Init();
        }
        ...
        public ZeroitAnimatorEdit(IContainer container)
        {
            container.Add(this);
            Init();
        }
        ...
        {
            //AnimationType = Zeroit.Framework.Transitions.AnimatorWithEditor.AnimationType.Mosaic;
        ...
        {
            get { return animateInput.Target; }
            set
            {
                animateInput.Target = value;
            }
        }
        ...
        {
            get { return animateInput.TargetWidth; }
            set
            {
                animateInput.TargetWidth = value;
            }
        }
        ...
        {
            get { return animateInput.TargetHeight; }
            set
            {
                animateInput.TargetHeight = value;
            }
        }
        ...
        public void Activate()
        {
            ...
            Target.Width = animateInput.TargetWidth;
            Target.Height = animateInput.TargetHeight;
            ...
            switch (AnimationType)
            {
                case AnimationType.Custom:
                    this.ShowSync(Target);
                    break;
                case AnimationType.Rotate:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.Rotate);
                    break;
                case AnimationType.HorizSlide:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.HorizSlide);
                    break;
                case AnimationType.VertSlide:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.VertSlide);
                    break;
                case AnimationType.Scale:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.Scale);
                    break;
                case AnimationType.ScaleAndRotate:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.ScaleAndRotate);
                    break;
                case AnimationType.HorizSlideAndRotate:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.HorizSlideAndRotate);
                    break;
                case AnimationType.ScaleAndHorizSlide:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.ScaleAndHorizSlide);
                    break;
                case AnimationType.Transparent:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.Transparent);
                    break;
                case AnimationType.Leaf:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.Leaf);
                    break;
                case AnimationType.Mosaic:
                    this.ShowSync(Target,false, ZeroitAnimate_Animation.Mosaic);
                    break;
                case AnimationType.Particles:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.Particles);
                    break;
                case AnimationType.VertBlind:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.VertBlind);
                    break;
                case AnimationType.HorizBlind:
                    this.ShowSync(Target, false, ZeroitAnimate_Animation.HorizBlind);
                    break;
                default:
                    break;
            }
        ...
        //{
        //    get { return animateInput.TimeStep; }
        //    set
        //    {
        //        animateInput.TimeStep = value;
        //    }
        //}
    ...
    /// <summary>
    /// Sets the type of decoration for <c><see cref="ZeroitAnimatorEdit" /></c>
    /// </summary>
    ...
    /// <summary>
    /// Sets the animation mode for <c><see cref="ZeroitAnimatorEdit" /></c>
    /// </summary>
