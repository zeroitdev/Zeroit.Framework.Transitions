...
namespace Zeroit.Framework.Transitions.AnimatorWithEditor
{
    ...
    class DecorationControl : UserControl
    {
        ...
        private void InitPadding()
        {
            ...
            {
                case Zeroit.Framework.Transitions.AnimatorWithEditor.DecorationType.BottomMirror:
        ...
        void tm_Tick(object sender, EventArgs e)
        {
            ...
            {
                case Zeroit.Framework.Transitions.AnimatorWithEditor.DecorationType.BottomMirror:
                case Zeroit.Framework.Transitions.AnimatorWithEditor.DecorationType.Custom:
                    Invalidate();
                    break;
            }
        }
