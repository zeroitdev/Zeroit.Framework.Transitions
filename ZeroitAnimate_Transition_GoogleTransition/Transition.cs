...
namespace Zeroit.Framework.Transitions
{
    ...
    public class ZeroitTransitor : Component
    {
        ...
        /// </summary>
        /// <value>The type transition.</value>
        ...
        /// <summary>
        /// Gets or sets the animation's position.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the number of swings.
        /// </summary>
        /// <value>The number of flashes.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitTransitor" /> class.
        /// </summary>
        public ZeroitTransitor()
        {
        ...
        public static void runChain(params ZeroitTransitor[] transitions)
        {
        ...
        /// </summary>
        /// <param name="transitionMethod">The transition method.</param>
        public ZeroitTransitor(ITransitionType transitionMethod)
        {
