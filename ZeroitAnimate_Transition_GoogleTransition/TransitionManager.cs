...
namespace Zeroit.Framework.Transitions
{
    ...
    internal class TransitionManager
    {
        ...
        private void onTimerElapsed(object sender, ElapsedEventArgs e)
        {
            ...
            foreach (ZeroitTransitor transition in listTransitions)
            {
                transition.onTimer();
            }
        ...
        /// The m transitions
        /// </summary>
        private IDictionary<ZeroitTransitor, bool> m_Transitions = new Dictionary<ZeroitTransitor, bool>();
