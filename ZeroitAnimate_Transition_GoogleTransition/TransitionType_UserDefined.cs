...
namespace Zeroit.Framework.Transitions
{
    ...
    public class TransitionType_UserDefined : ITransitionType
    {
        ...
        /// <param name="elements">The elements.</param>
        /// <param name="iTransitionTime">The i transition time.</param>
        /// <exception cref="Exception">The list of elements passed to the constructor of TransitionType_UserDefined had zero elements. It must have at least one element.</exception>
        ...
        /// <exception cref="Exception">Interpolation method not handled: " + eInterpolationMethod.ToString()</exception>
