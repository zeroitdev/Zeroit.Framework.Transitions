...
// ***********************************************************************
// <copyright file="TransitionType_Zeroit.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Transitions
{
    ...
    public class TransitionType_Zeroit : TransitionType_UserDefined
    {
        ...
        public TransitionType_Zeroit(int iTransitionTime)
        {
            ...
            elements.Add(new TransitionElement(-50, 0, InterpolationMethod.Deceleration));
            //elements.Add(new TransitionElement(50, 100, InterpolationMethod.Accleration));
