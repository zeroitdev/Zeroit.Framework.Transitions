...
namespace Zeroit.Framework.Transitions.ZeroitAnimateTransitionWithEditor
{
    ...
    internal class TransitionChain
    {
        ...
        public TransitionChain(params ZeroitTransitorEdit[] transitions)
        {
            // We store the list of transitions...
            foreach (ZeroitTransitorEdit transition in transitions)
            {
        ...
        /// </summary>
        private LinkedList<ZeroitTransitorEdit> m_listTransitions = new LinkedList<ZeroitTransitorEdit>();
