...
// ***********************************************************************
// <copyright file="TransitionType_UserDefined.cs" company="Zeroit Dev Technologies">
...
{
    #region TransitionType_UserDefined
    /// <summary>
    ...
    public class TransitionType_UserDefined : ITransitionType
    {
        ...
        /// <param name="elements">The elements.</param>
        /// <param name="iTransitionTime">The i transition time.</param>
        /// <exception cref="System.Exception">The list of elements passed to the constructor of TransitionType_UserDefined had zero elements. It must have at least one element.</exception>
        ...
        /// <exception cref="System.Exception">Interpolation method not handled: " + eInterpolationMethod.ToString()</exception>
        ...
        /// </summary>
        /// <param name="dTimeFraction">The d time fraction.</param>
        /// <param name="dStartTime">The d start time.</param>
        /// <param name="dEndTime">The d end time.</param>
        /// <param name="dStartValue">The d start value.</param>
        /// <param name="dEndValue">The d end value.</param>
        /// <param name="eInterpolationMethod">The e interpolation method.</param>
