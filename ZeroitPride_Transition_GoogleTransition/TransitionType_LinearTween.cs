...
// ***********************************************************************
// <copyright file="TransitionType_LinearTween.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Transitions.FormSpark.GoogleTransition
{
    ...
    public class TransitionType_LinearTween : ITransitionType
    {
        /// <summary>
        /// The utils
        /// </summary>
        ...
        public TransitionType_LinearTween(int iTransitionTime, double d, double c, double b)
        {
            utils.b = b;
            utils.c = c;
            utils.d = d;
        ...
        public void onTimer(int iTime, out double dPercentage, out bool bCompleted)
        {
            ...
            dPercentage = utils.convertLinearToLinearTween(dElapsed);
