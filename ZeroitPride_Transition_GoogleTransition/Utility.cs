...
namespace Zeroit.Framework.Transitions.FormSpark.GoogleTransition
{
    ...
    internal class Utility
    {
        ...
        /// <exception cref="System.Exception">Object: " + target.ToString() + " does not have the property: " + strPropertyName</exception>
        ...
        /// <param name="dElapsed">The d elapsed.</param>
        /// <returns>Output between 0 and 1.</returns>
        public double convertLinearToLinearTween(double dElapsed)
        {
        ...
        /// <param name="dElapsed">The d elapsed.</param>
        /// <returns>Output between 0 and 1.</returns>
        public double convertLinearToEaseInQuad(double dElapsed)
        {
            t /= d;
            c = dElapsed/0.5;
            return c * t * 2*(t + b);
