...
// ***********************************************************************
// <copyright file="Zeroit_Transitions.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Transitions
{
    ...
    static class RoundRectangle
    {
        ...
        public static GraphicsPath RoundRect(Rectangle Rectangle, int Curve)
        {
            ...
            GP.AddLine(new System.Drawing.Point(Rectangle.X, Rectangle.Height - EndArcWidth + Rectangle.Y), new System.Drawing.Point(Rectangle.X, Curve + Rectangle.Y));
            return GP;
        }
    ...
    /// Class MSColorTable.
    /// </summary>
    /// <seealso cref="Zeroit.Framework.Transitions.ColorTable" />
    ...
    /// </summary>
    /// <seealso cref="Zeroit.Framework.Transitions.xColorTable" />
    ...
    public class ControlRenderer : ToolStripProfessionalRenderer
    {
        ...
        protected override void OnRenderItemCheck(System.Windows.Forms.ToolStripItemImageRenderEventArgs e)
        {
            ...
            e.Graphics.DrawString("ü", new Font("Wingdings", 13, System.Drawing.FontStyle.Regular), Brushes.Black, new System.Drawing.Point(4, 2));
        }
    ...
    public abstract class ThemeContainer154 : ContainerControl
    {
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (WM_LMBUTTONDOWN && m.Msg == 513)
            {
                ...
                if (IsParentMdi)
                {
                    CorrectBounds(new Rectangle(System.Drawing.Point.Empty, Parent.Parent.Size));
                }
                else
                {
        ...
        /// The get index point
        /// </summary>
        private System.Drawing.Point GetIndexPoint;
        /// <summary>
        /// The b1
        /// </summary>
        private bool B1;
        ...
        /// </summary>
        private System.Drawing.Point OffsetReturnPoint;
        /// <summary>
        ...
        protected System.Drawing.Point Offset(System.Drawing.Point p, int amount)
        {
        ...
        /// The center return
        /// </summary>
        private System.Drawing.Point CenterReturn;
        /// <summary>
        ...
        /// <returns>System.Drawing.Point.</returns>
        protected System.Drawing.Point Center(Rectangle p, Rectangle c)
        {
        ...
        /// <param name="c">The c.</param>
        /// <returns>System.Drawing.Point.</returns>
        protected System.Drawing.Point Center(Rectangle p, System.Drawing.Size c)
        {
        ...
        /// <returns>System.Drawing.Point.</returns>
        protected System.Drawing.Point Center(Rectangle child)
        {
        ...
        /// <param name="child">The child.</param>
        /// <returns>System.Drawing.Point.</returns>
        protected System.Drawing.Point Center(System.Drawing.Size child)
        {
            return Center(Width, Height, child.Width, child.Height);
        }
        /// <summary>
        ...
        /// <returns>System.Drawing.Point.</returns>
        protected System.Drawing.Point Center(int childWidth, int childHeight)
        {
        ...
        /// <param name="c">The c.</param>
        /// <returns>System.Drawing.Point.</returns>
        protected System.Drawing.Point Center(System.Drawing.Size p, System.Drawing.Size c)
        {
        ...
        /// <returns>System.Drawing.Point.</returns>
        protected System.Drawing.Point Center(int pWidth, int pHeight, int cWidth, int cHeight)
        {
        ...
        /// The draw text point
        /// </summary>
        private System.Drawing.Point DrawTextPoint;
        ...
        /// <param name="x">The x.</param>
        /// <param name="y">The y.</param>
        protected void DrawText(Brush b1, System.Windows.Forms.HorizontalAlignment a, int x, int y)
        {
        ...
        /// <param name="x">The x.</param>
        /// <param name="y">The y.</param>
        protected void DrawText(Brush b1, string text, System.Windows.Forms.HorizontalAlignment a, int x, int y)
        {
            if (text.Length == 0)
                return;
        ...
        /// <param name="b1">The b1.</param>
        /// <param name="p1">The p1.</param>
        protected void DrawText(Brush b1, System.Drawing.Point p1)
        {
            if (Text.Length == 0)
                return;
        ...
        /// </summary>
        private System.Drawing.Point DrawImagePoint;
        /// <summary>
        /// Draws the image.
        /// </summary>
        /// <param name="a">a.</param>
        /// <param name="x">The x.</param>
        /// <param name="y">The y.</param>
        protected void DrawImage(System.Windows.Forms.HorizontalAlignment a, int x, int y)
        {
        ...
        /// <param name="x">The x.</param>
        /// <param name="y">The y.</param>
        protected void DrawImage(Image image, System.Windows.Forms.HorizontalAlignment a, int x, int y)
        {
            if (image == null)
                return;
        ...
        /// </summary>
        /// <param name="p1">The p1.</param>
        protected void DrawImage(System.Drawing.Point p1)
        {
        ...
        /// <param name="image">The image.</param>
        /// <param name="p1">The p1.</param>
        protected void DrawImage(Image image, System.Drawing.Point p1)
        {
        ...
        public void DrawRadial(ColorBlend blend, int x, int y, int width, int height, System.Drawing.Point center)
        {
            DrawRadialRectangle = new Rectangle(x, y, width, height);
        ...
        /// <param name="r">The r.</param>
        /// <param name="center">The center.</param>
        public void DrawRadial(ColorBlend blend, Rectangle r, System.Drawing.Point center)
        {
    ...
    /// <summary>
    /// An enumeration for rendering mouse capabilities for the editors' themes.
    /// </summary>
    ...
    public abstract class ThemeControl : Control
    {
        ...
        /// <param name="c">The c.</param>
        /// <param name="x">The x.</param>
        protected void DrawText(System.Windows.Forms.HorizontalAlignment a, Color c, int x)
        {
            DrawText(a, c, x, 0);
        }
        /// <summary>
        ...
        /// <param name="x">The x.</param>
        /// <param name="y">The y.</param>
        protected void DrawText(System.Windows.Forms.HorizontalAlignment a, Color c, int x, int y)
        {
        ...
        /// <param name="a">a.</param>
        /// <param name="x">The x.</param>
        protected void DrawIcon(System.Windows.Forms.HorizontalAlignment a, int x)
        {
            DrawIcon(a, x, 0);
        }
        /// <summary>
        ...
        /// <param name="x">The x.</param>
        /// <param name="y">The y.</param>
        protected void DrawIcon(System.Windows.Forms.HorizontalAlignment a, int x, int y)
        {
            if (_Image == null)
                return;
            switch (a)
    ...
    public abstract class Theme : ContainerControl
    {
        ...
        /// The PTC
        /// </summary>
        private System.Drawing.Point PTC;
        /// <summary>
        /// Gets the pointer.
        /// </summary>
    ...
    public static class Helpers
    {
        ...
        /// <returns>Rectangle.</returns>
        public static Rectangle FullRectangle(System.Drawing.Size S, bool Subtract)
        {
            if (Subtract)
            {
        ...
        public static void CenterString(Graphics G, string T, Font F, Color C, Rectangle R)
        {
            ...
            using (SolidBrush B = new SolidBrush(C))
            {
                G.DrawString(T, F, B, new System.Drawing.Point(R.Width / 2 - (int)(TS.Width / 2), R.Height / 2 - (int)(TS.Height / 2)));
            }
        }
        ...
        /// <summary>
        /// Helper enumeration for setting rectangular direction.
        /// </summary>
        ...
        public static void DrawTriangle(Graphics G, Rectangle Rect, Direction D, Color C)
        {
            ...
            System.Drawing.Point p0 = System.Drawing.Point.Empty;
            System.Drawing.Point p1 = System.Drawing.Point.Empty;
            System.Drawing.Point p2 = System.Drawing.Point.Empty;

            switch (D)
            {
                case Direction.Up:
                    p0 = new System.Drawing.Point(Rect.Left + halfWidth, Rect.Top);
                    p1 = new System.Drawing.Point(Rect.Left, Rect.Bottom);
                    p2 = new System.Drawing.Point(Rect.Right, Rect.Bottom);

                    break;
                case Direction.Down:
                    p0 = new System.Drawing.Point(Rect.Left + halfWidth, Rect.Bottom);
                    p1 = new System.Drawing.Point(Rect.Left, Rect.Top);
                    p2 = new System.Drawing.Point(Rect.Right, Rect.Top);

                    break;
                case Direction.Left:
                    p0 = new System.Drawing.Point(Rect.Left, Rect.Top + halfHeight);
                    p1 = new System.Drawing.Point(Rect.Right, Rect.Top);
                    p2 = new System.Drawing.Point(Rect.Right, Rect.Bottom);

                    break;
                case Direction.Right:
                    p0 = new System.Drawing.Point(Rect.Right, Rect.Top + halfHeight);
                    p1 = new System.Drawing.Point(Rect.Left, Rect.Bottom);
                    p2 = new System.Drawing.Point(Rect.Left, Rect.Top);
            ...
            using (SolidBrush B = new SolidBrush(C))
            {
                G.FillPolygon(B, new System.Drawing.Point[] {
                p0,
                p1,
                p2
            });
    ...
    [ToolboxItem(false)]
    public class RotatingAnimation : Component
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RotatingAnimation"/> class.
        /// </summary>
        ...
        public void Control_Paint(object sender, PaintEventArgs e)
        {
            ...
            control.CreateGraphics().SmoothingMode = SmoothingMode.AntiAlias;
            ...
            if(DesignMode)
            {
                if (rotatingBorder)
                {
                    control.CreateGraphics().DrawEllipse(new Pen(Color.Red), new Rectangle(0, 0, control.Width - 2, control.Height - 2));
                }

                control.CreateGraphics().TranslateTransform(control.Width / 2, control.Height / 2);

                // Then to rotate, prepending rotation matrix.
                control.CreateGraphics().RotateTransform(angle);

                //// Draw rotated, translated ellipse to screen.
                //e.Graphics.DrawRectangle(new Pen(Color.Blue, 3), 0, 0, 100, 100);
