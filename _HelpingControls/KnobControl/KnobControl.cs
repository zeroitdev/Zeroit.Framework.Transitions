...
// ***********************************************************************
// <copyright file="KnobControl.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.Transitions._HelpingControls.KnobControl
{
    #region KnobControl
    ...
    public class ZeroitKnobSmartTagActionList : System.ComponentModel.Design.DesignerActionList
    {
        ...
        /// </summary>
        /// <value>The knob pointer style.</value>
        public ZeroitKnob.knobPointerStyle KnobPointerStyle
        {
            get
            {
